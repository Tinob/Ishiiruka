...
void VertexManager::vFlush(bool useDstAlpha)
{
	...
	{
		ProgramShaderCache::SetShader(DSTALPHA_DUAL_SOURCE_BLEND, VertexLoaderManager::g_current_components, current_primitive_type);
	}
	else
	{
		ProgramShaderCache::SetShader(DSTALPHA_NONE, VertexLoaderManager::g_current_components, current_primitive_type);
	}
	...
	if (useDstAlpha && !dualSourcePossible)
	{
		ProgramShaderCache::SetShader(DSTALPHA_ALPHA_PASS, VertexLoaderManager::g_current_components, current_primitive_type);
