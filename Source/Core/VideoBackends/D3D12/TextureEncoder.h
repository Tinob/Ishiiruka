...
// the encoder
static const unsigned int s_max_bytes_per_block_row = (EFB_WIDTH / 4) * 64;
// The maximum amount of data that the texture encoder can generate in one call
static const unsigned int s_max_bytes_per_encode = s_max_bytes_per_block_row * (EFB_HEIGHT / 4);
