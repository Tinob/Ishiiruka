...
#define DESCRIPTOR_TABLE_DS_SRV     2
#define DESCRIPTOR_TABLE_DS_SAMPLER 3
#define DESCRIPTOR_TABLE_HS_CBV0    4
#define DESCRIPTOR_TABLE_HS_CBV1    5
#define DESCRIPTOR_TABLE_HS_CBV2    6
#define DESCRIPTOR_TABLE_GS_CBV     7
#define DESCRIPTOR_TABLE_DS_CBV0    8
#define DESCRIPTOR_TABLE_DS_CBV1    9
#define DESCRIPTOR_TABLE_DS_CBV2    10
#define DESCRIPTOR_TABLE_VS_CBV     11
#define DESCRIPTOR_TABLE_PS_CBVONE  12
#define DESCRIPTOR_TABLE_PS_CBVTWO  13
#define DESCRIPTOR_TABLE_PS_UAV     14
