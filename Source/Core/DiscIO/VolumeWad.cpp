	...
	m_hdr_size(0), m_cert_size(0), m_tick_size(0), m_tmd_size(0), m_data_size(0)
{
	...
	m_offset = Common::AlignUpSizePow2(Common::swap32(m_hdr_size), 0x40) +
		Common::AlignUpSizePow2(Common::swap32(m_cert_size), 0x40);
	m_tmd_offset = Common::AlignUpSizePow2(Common::swap32(m_hdr_size), 0x40) +
		Common::AlignUpSizePow2(Common::swap32(m_cert_size), 0x40) +
		Common::AlignUpSizePow2(Common::swap32(m_tick_size), 0x40);
	m_opening_bnr_offset = m_tmd_offset + Common::AlignUpSizePow2(Common::swap32(m_tmd_size), 0x40) +
		Common::AlignUpSizePow2(Common::swap32(m_data_size), 0x40);
}
