...
public:
	...
	virtual void Swap()
	{}
	virtual void SetMode(GLInterfaceMode mode)
	{
		s_opengl_mode = GLInterfaceMode::MODE_OPENGL;
	}
	virtual GLInterfaceMode GetMode()
	{
		return s_opengl_mode;
	}
	virtual void* GetFuncAddress(const std::string& name)
	{
		return nullptr;
	}
	virtual bool Create(void *window_handle, bool core = true)
	{
		return true;
	}
	virtual bool Create(cInterfaceBase* main_context)
	{
		return true;
	}
	...
	virtual u32 GetBackBufferHeight()
	{
		return s_backbuffer_height;
	}
	virtual void SetBackBufferDimensions(u32 W, u32 H)
	{
		s_backbuffer_width = W; s_backbuffer_height = H;
	}
	virtual u32 GetWindowXPos()
	{
		return s_window_xpos;
	}
	virtual u32 GetWindowYPos()
	{
		return s_window_ypos;
	}
	virtual void Update()
	{}
	...
	{}
	virtual std::unique_ptr<cInterfaceBase> CreateSharedContext()
	{
		return nullptr;
	}
};
