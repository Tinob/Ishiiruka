...
void BlendingState::Generate(const BPMemory& bp)
{
  ...
  bool target_has_alpha = bp.zcontrol.pixel_format.Value() == PEControl::RGBA6_Z24;
  ...
  usedualsrc = g_ActiveConfig.backend_info.bSupportsDualSourceBlend && dstalpha;
  ...
  else if (bp.blendmode.logicopenable && bp.blendmode.logicmode.Value() != BlendMode::LogicOp::COPY)
  {
