...
// num_verts= 24932407
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[22887189925897] = TemplatedLoader<0x401, 0x000f0f00u, 0x40a00c09u, 0x00000009u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 11329846
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[20164974968470] = TemplatedLoader<0x401, 0x00001100u, 0x4000e007u, 0x00000000u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 10822718
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[31133432690185] = TemplatedLoader<0x401, 0x003f0f00u, 0x41201009u, 0x00001209u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 7671147
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[23044654928905] = TemplatedLoader<0x401, 0x000f0f00u, 0x41201009u, 0x00000009u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 5082850
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[21022441425720] = TemplatedLoader<0x401, 0x00030f00u, 0x41200c09u, 0x00000000u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 972930
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[20168242313528] = TemplatedLoader<0x401, 0x00001500u, 0x40016409u, 0x00000000u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 742268
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[23044635709449] = TemplatedLoader<0x401, 0x000f0f00u, 0x41200c09u, 0x00000009u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 730216
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[30975967687177] = TemplatedLoader<0x401, 0x003f0f00u, 0x40a00c09u, 0x00001209u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 558356
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[20452190556472] = TemplatedLoader<0x401, 0x00011100u, 0x40616009u, 0x00000000u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 258020
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[20162659061560] = TemplatedLoader<0x401, 0x00000f00u, 0x40001009u, 0x00000000u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 228150
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[31133413470729] = TemplatedLoader<0x401, 0x003f0f00u, 0x41200c09u, 0x00001209u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 26400
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[24058683668489] = TemplatedLoader<0x401, 0x00151100u, 0x41216009u, 0x00001209u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 10372
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[20168299971896] = TemplatedLoader<0x401, 0x00001500u, 0x40017009u, 0x00000000u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
...
// num_verts= 3972
	...
	if (cpu_info.bSSE4_1)
	{
		pvlmap[20518689874232] = TemplatedLoader<0x401, 0x00010100u, 0x40a00009u, 0x00000000u, 0x00000000u>;
	}
	else
#endif
#if _M_SSE >= 0x301
