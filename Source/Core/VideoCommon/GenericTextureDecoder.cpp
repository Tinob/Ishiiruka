...
s32 GetTextureSizeInBytes(s32 width, s32 height, s32 format)
{
...
static HostTextureFormat GetPCFormatFromTLUTFormat(s32 tlutfmt)
{
  switch (tlutfmt)
  {
...
HostTextureFormat GetPC_TexFormat(s32 texformat, s32 tlutfmt)
{
  switch (texformat)
  {
  case GX_TF_C4:
...
HostTextureFormat Decode_real(u8 *dst, const u8 *src, s32 width, s32 height, s32 texformat, s32 tlutaddr, s32 tlutfmt)
{
...
HostTextureFormat Decode_RGBA(u32 * dst, const u8 * src, s32 width, s32 height, s32 texformat, s32 tlutaddr, s32 tlutfmt)
{
...
HostTextureFormat Decode(u8 *dst, const u8 *src, s32 width, s32 height, s32 texformat, s32 tlutaddr, s32 tlutfmt, bool rgbaOnly)
{
  HostTextureFormat retval = rgbaOnly ? Decode_RGBA((u32*)dst, src,
...
void DecodeTexel(u8 *dst, const u8 *src, s32 s, s32 t, s32 imageWidth, s32 texformat, s32 tlutaddr, s32 tlutfmt)
{
...
void DecodeTexelRGBA8FromTmem(u8 *dst, const u8 *src_ar, const u8* src_gb, s32 s, s32 t, s32 imageWidth)
{
  u16 sBlk = s >> 2;
  u16 tBlk = t >> 2;
...
HostTextureFormat DecodeRGBA8FromTmem(u8* dst, const u8 *src_ar, const u8 *src_gb, s32 width, s32 height)
{
